...
const AdminDashboard = () => {
  ...
  return (
   ...
   <b> Greetings from your admin dashboard.  You can watch the statistics and control all of the settings here.    </b>                </p>
                  </div>
                </div>
              </div>
            </div>
            <div className="hidden xl:flex bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] justify-center items-center rounded-2xl">
              <h4 className="overflow-y-hidden">
                "Engaging in the pursuit of reading cultivates personal development, fostering a trajectory towards excellence and the refinement of character."
              </h4>
