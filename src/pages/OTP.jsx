    ...
    <>
      <div className="flex flex-col justify-center md:flex-row h-screen">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center bg-silver-100 p-8 relative">
          <Link
            to={"/register"}
            className="border-2 border-blue-900 rounded-3xl font-bold w-52 py-2 px-4 fixed top-10 -left-28 hover:bg-blue-900 hover:text-silver-100 transition duration-300 text-end"
          >
            Back
          </Link>
          <div className="max-w-sm w-full">
            ...
            <h1 className="text-4xl font-medium text-center mb-12 overflow-hidden text-blue-900">
              Check your Mailbox
            </h1>
            ...
            <form onSubmit={handleOtpVerification}>
              ...
              <button
                type="submit"
                className="border-2 mt-5 border-blue-900 w-full font-semibold bg-blue-900 text-silver-100 py-2 rounded-lg hover:bg-silver-100 hover:text-blue-900 transition"
              >
                VERIFY
              </button>
            </form>
        ...
        {/* RIGHT SIDE */}
        <div className="hidden w-full md:w-1/2 bg-blue-900 text-silver-100 md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
          <div className="text-center h-[400px]">
            <div className="flex justify-center mb-12">
              <img
                src={logo_with_title}
            ...
            <Link
              to={"/register"}
              className="border-2 mt-5 border-silver-100 px-8 w-full font-semibold bg-blue-900 text-silver-100 py-2 rounded-lg hover:bg-silver-100 hover:text-blue-900 transition"
            >
              SIGN UP
            </Link>
          </div>
